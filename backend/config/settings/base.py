...
YUKI_AUTHENTICATION_URL = env("YUKI_AUTHENTICATION_URL", default="https://default-auth-url.com")
YUKI_API_KEY = env("YUKI_API_KEY", default="default-api-key")
YUKI_ADMIN_ID = env("YUKI_ADMIN_ID", default="default-admin-id")
