...
class DjangoInvoiceRepository(InvoiceRepository):
    ...
    def _to_django(
        ...
        Args:
            ...
            file_path: Optional path to stored file. If not provided, will be updated later.
    ...
    def save(self, invoice: DomainInvoice, user_id: int) -> DomainInvoice:
        ...
        db_invoice = self._to_django(invoice, user_id) #come back to this later
        db_invoice.save()
    ...
    def update(self, invoice: DomainInvoice, user_id: int) -> DomainInvoice:
        ...
        try:
            ...
            db_invoice.uploaded_by_id = user_id  # Update the user who modified it
            db_invoice.save()
            return self._to_domain(db_invoice)
