  ...
  return (
    <div className="w-full max-w-4xl rounded-lg bg-white p-6 shadow-md">
      ...
      <div className="mb-2 flex items-center justify-between">
        ...
        <span className="cursor-pointer font-medium text-blue-600">Weekly ▾</span>
      </div>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" dataKey="thisWeek" stroke="#2563eb" strokeWidth={3} dot={false} />
          <Line type="monotone" dataKey="lastWeek" stroke="#ef4444" strokeWidth={2} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
